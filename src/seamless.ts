...
export const seamless = ({ force = false, duration = 468, win = window as IWindow, doc = document }: IOption = {}) => {
    ...
    const now: () => number =
        win.performance && win.performance.now ? win.performance.now.bind(win.performance) : Date.now;
    ...
    const canOverflow = (el: Element, axis: "X" | "Y"): boolean => {
        const overflowValue = win.getComputedStyle(el, null)[("overflow" + axis) as "overflowX" | "overflowY"];
    ...
    function winScrollBy(firstArg?: any, secondArg?: any): void {
        ...
        if (shouldBailOut(firstArg)) {
            original.scrollBy.call(
                win,
                firstArg.left !== undefined ? firstArg.left : typeof firstArg !== "object" ? firstArg : 0,
                firstArg.top !== undefined ? firstArg.top : secondArg !== undefined ? secondArg : 0,
            );
    ...
    function eleScrollTo(this: Element, firstArg?: any, secondArg?: any): void {
        ...
        const { left = this.scrollLeft, top = this.scrollTop } = firstArg as ScrollToOptions;
    ...
    function eleScrollBy(this: Element, firstArg?: any, secondArg?: any) {
        ...
        if (shouldBailOut(firstArg) === true) {
            original.elementScroll.call(
                this,
                firstArg.left !== undefined ? ~~firstArg.left + this.scrollLeft : ~~firstArg + this.scrollLeft,
                firstArg.top !== undefined ? ~~firstArg.top + this.scrollTop : ~~secondArg + this.scrollTop,
            );
    ...
    win.Element.prototype.scrollIntoView = function(this: Element, arg?: boolean | ScrollIntoViewOptions): void {
        // avoid smooth behavior if not required
